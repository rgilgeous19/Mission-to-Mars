...
def hems_img(browser):
    ...
    hems_soup = soup(hems_html, 'html.parser')
    
    items = hems_soup.find_all('div', class_='item')
    
    
    #creating a list to hold images and titles
    ...
    for x in items:
        ...
        hems_img_urls.append(hemisphere)
        
        browser.back()
        
        
    return hems_img_urls
